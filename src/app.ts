...
const schemaUID =
  "0x327ff96e3e610b2c0d090a3a8d2b995644461930ca1ab54431222e2fd09bbaa9";
...
const schemaEncoder = new SchemaEncoder(
  "string DAO_name,bytes32 ticket_ref,bool is_payed,string event_name"
);
const encodedData = schemaEncoder.encodeData([
  { name: "DAO_name", value: "frutero_club", type: "string" },
  {
    name: "ticket_ref",
    value: "0x746869732069732e20746865207469636b6574207265666572656e6365000000",
    type: "bytes32",
  },
